...
const (
	Mail_SendMail_FullMethodName = "/mail.service.mail/SendMail"
)
...
type MailClient interface {
	SendMail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *mailClient) SendMail(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type MailServer interface {
	SendMail(context.Context, *SendMailRequest) (*emptypb.Empty, error)
...
func (UnimplementedMailServer) SendMail(context.Context, *SendMailRequest) (*emptypb.Empty, error) {

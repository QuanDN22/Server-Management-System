...
const (
	...
	ManagementSystem_ViewServer_FullMethodName   = "/management.system.service.ManagementSystem/ViewServer"
	...
	ManagementSystem_Report_FullMethodName       = "/management.system.service.ManagementSystem/Report"
	ManagementSystem_GetAllServer_FullMethodName = "/management.system.service.ManagementSystem/GetAllServer"
)
...
type ManagementSystemClient interface {
	...
	GetAllServer(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllServerResponse, error)
}
...
func (c *managementSystemClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, ManagementSystem_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) CreateServer(ctx context.Context, in *CreateServerRequest, opts ...grpc.CallOption) (*Server, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Server)
	err := c.cc.Invoke(ctx, ManagementSystem_CreateServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) ViewServer(ctx context.Context, in *ViewServerRequest, opts ...grpc.CallOption) (*ViewServerResponse, error) {
	...
	err := c.cc.Invoke(ctx, ManagementSystem_ViewServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) UpdateServer(ctx context.Context, in *UpdateServerRequest, opts ...grpc.CallOption) (*Server, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Server)
	err := c.cc.Invoke(ctx, ManagementSystem_UpdateServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) DeleteServer(ctx context.Context, in *DeleteServerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ManagementSystem_DeleteServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) ImportServer(ctx context.Context, opts ...grpc.CallOption) (ManagementSystem_ImportServerClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ManagementSystem_ServiceDesc.Streams[0], ManagementSystem_ImportServer_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &managementSystemImportServerClient{ClientStream: stream}
	return x, nil
}
...
func (c *managementSystemClient) Report(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ManagementSystem_Report_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) GetAllServer(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllServerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllServerResponse)
	err := c.cc.Invoke(ctx, ManagementSystem_GetAllServer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagementSystemServer interface {
	...
	// Get all server_id and server_ipv4
	GetAllServer(context.Context, *emptypb.Empty) (*GetAllServerResponse, error)
...
func (UnimplementedManagementSystemServer) Report(context.Context, *ReportRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Report not implemented")
}
func (UnimplementedManagementSystemServer) GetAllServer(context.Context, *emptypb.Empty) (*GetAllServerResponse, error) {
...
func _ManagementSystem_ViewServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagementSystem_ViewServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ManagementSystem_ImportServer_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ManagementSystemServer).ImportServer(&managementSystemImportServerServer{ServerStream: stream})
}
...
func _ManagementSystem_Report_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagementSystemServer).Report(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagementSystem_Report_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagementSystemServer).Report(ctx, req.(*ReportRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ManagementSystem_GetAllServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagementSystemServer).GetAllServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ManagementSystem_GetAllServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagementSystemServer).GetAllServer(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ManagementSystem_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Report",
			Handler:    _ManagementSystem_Report_Handler,
		},
		{
			MethodName: "GetAllServer",
			Handler:    _ManagementSystem_GetAllServer_Handler,
		},
	},

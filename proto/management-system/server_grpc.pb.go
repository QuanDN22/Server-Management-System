...
type ManagementSystemClient interface {
	...
	// Get all server_ip
	GetAllServerIP(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllServerIPResponse, error)
}
...
func (c *managementSystemClient) Report(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/management.system.service.ManagementSystem/Report", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managementSystemClient) GetAllServerIP(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetAllServerIPResponse, error) {
	out := new(GetAllServerIPResponse)
	err := c.cc.Invoke(ctx, "/management.system.service.ManagementSystem/GetAllServerIP", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagementSystemServer interface {
	...
	// Get all server_ip
	GetAllServerIP(context.Context, *empty.Empty) (*GetAllServerIPResponse, error)
...
func (UnimplementedManagementSystemServer) Report(context.Context, *ReportRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Report not implemented")
}
func (UnimplementedManagementSystemServer) GetAllServerIP(context.Context, *empty.Empty) (*GetAllServerIPResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllServerIP not implemented")
}
...
func _ManagementSystem_Report_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.system.service.ManagementSystem/Report",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ManagementSystem_GetAllServerIP_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagementSystemServer).GetAllServerIP(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.system.service.ManagementSystem/GetAllServerIP",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagementSystemServer).GetAllServerIP(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ManagementSystem_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllServerIP",
			Handler:    _ManagementSystem_GetAllServerIP_Handler,
		},
	},
